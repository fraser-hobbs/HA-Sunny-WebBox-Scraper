...
class SMAWebBoxConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_device(self, user_input=None):
        """Handle device key and scan interval configuration."""
        errors = {}
    ...
    def async_get_options_flow(config_entry):
        ...
        return SMAWebBoxOptionsFlow(config_entry)


class SMAWebBoxOptionsFlow(config_entries.OptionsFlow):
    """Handle options flow for SMA Sunny WebBox."""
